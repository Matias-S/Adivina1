...
bandera = 1 # Variable para ser usada una sola vez
    ...
    while True:
        try:
            ...
            if adivino > 10 or adivino < 1:
                ...
                bandera = 0 # Asignamos 0 a la bandera si el dato ingresado es satisfactorio
                break            
        ...
        if bandera == 0: #En el caso de que la bandera sea =0 debido a un valor ingresado correctamente, sale del ciclo y continúa el resto del programa
            break
